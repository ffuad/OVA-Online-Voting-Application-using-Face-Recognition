...
public class VoterSeeCandidateListCustomAdapter extends ArrayAdapter<NewCandidateData> {

    private Activity context;
    private List<NewCandidateData> CandidateDataList;

    public VoterSeeCandidateListCustomAdapter(Activity context, List<NewCandidateData> CandidateDataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.candidate_list_sample_layout_for_voter, null, true);
